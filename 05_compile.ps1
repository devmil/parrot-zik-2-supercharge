...
echo "Signing apk"
echo "============================"
$jarSignerProcess = Start-Process jarsigner -ArgumentList "-verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore 01_key\de.devmil.parrotzik2supercharge.keystore 06_result\de.devmil.parrotzik2supercharge_signed.apk market" -Wait
